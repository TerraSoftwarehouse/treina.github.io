...
let pergunta07 = ["Pergunta 7: Quais são os papéis essenciais do Scrum?", "Gerente de projeto e Cliente", "Scrum Master, Cliente e patrocinador", "Programador e Stakeholder", "Scrum Master, Product Owner e Equipe Scrum", 6];
let pergunta08 = ["Pergunta 8: Quem é responsável por garantir que o time tenha um produto backlog eficaz e claro no Scrum?", "O Product Owner", "O Scrum Master", "O time de desenvolvimento", "Todos os membros do Time", 7];
